function initPage() {
    ...
    let queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=524901&appid=5ca5cf6768b5b908101eaf7a5df3c311"
    console.log(queryURL)
    // https://api.openweathermap.org/data/2.5/forecast?id=524901&appid=5ca5cf6768b5b908101eaf7a5df3c311

    // function ExampleWeather(cityName) {
    ...
    let APIKey = "5ca5cf6768b5b908101eaf7a5df3c311";
...
//  Parse response to display current conditions
        //  Method for using "date" objects obtained from https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date
            ...
            let weatherPic = response.data.list[0].weather[0].icon;

           // currentPicEl.setAttribute("src","https://api.openweathermap.org/data/2.5/forecast?id=" + weatherPic + "@2x.png");
